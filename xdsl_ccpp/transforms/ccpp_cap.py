...
class CCPPCAP(ModulePass):
    ...
    def _collect_public_suite_functions(self, ops):
        """Scan all named ModuleOps in ops and return a map of public function names.
        ...
        Returns:
            dict mapping function_name → module_name for each public FuncOp
            definition found.
        """
        public_fns = {}
        for op in ops:
            ...
            for child in op.body.block.ops:
                if (
                    ...
                    public_fns[child.sym_name.data] = mod_name
        return public_fns
    ...
    def _generate_lifecycle_fn(
        ...
        callee_module = public_fns[suite_callee]
