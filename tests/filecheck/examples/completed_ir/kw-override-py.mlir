...
// CHECK-NEXT:        }
// CHECK-NEXT:        %15 = "llvm.mlir.addressof"() <{global_name = @const_initialized}> : () -> !llvm.ptr
...
// CHECK-NEXT:          "ccpp_utils.write_errmsg"(%errmsg, %13) <{prefix = "Invalid initial CCPP state, '", suffix = "' in kw_suite_physics"}> : (memref<512xi8>, !llvm.array<16 x i8>) -> ()
...
// CHECK-NEXT:          %18, %19 = "ccpp_utils.kw_call"(%lev) <{callee = "hello_scheme_run", operand_names = ["lev"], result_names = ["errmsg", "errflg"], overrides = {ncol = "5"}}> : (memref<i32>) -> (memref<512xi8>, memref<i32>)
...
// CHECK-LABEL:     func.func private @hello_scheme_run(memref<i32>, memref<i32>) -> (memref<512xi8>, memref<i32>)
// CHECK:         }
...
// CHECK-NEXT:        func.return %errmsg, %errflg : memref<512xi8>, memref<i32>
// CHECK-NEXT:      }
// CHECK-LABEL:     func.func public @Kw_ccpp_physics_run(%suite_name : memref<?xi8>, %suite_part : memref<?xi8>, %col_start : memref<i32>, %col_end : memref<i32>, %lev : memref<i32>, %errmsg : memref<512xi8>, %errflg : memref<i32>) -> (memref<512xi8>, memref<i32>) {
...
// CHECK-NEXT:          scf.if %4 {
// CHECK-NEXT:            %5, %6 = func.call @kw_suite_suite_physics(%col_start, %col_end, %lev) : (memref<i32>, memref<i32>, memref<i32>) -> (memref<512xi8>, memref<i32>)
